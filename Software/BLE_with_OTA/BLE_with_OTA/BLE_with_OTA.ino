...
void setup() {
 ...
 Key_Kommand[0] = KEY_UP_ARROW;
  ...
  Key_Kommand[288] = 0x60;//'´';
  Key_Kommand[289] = KEY_RIGHT_GUI; 
  Key_Kommand[290] = 0xE4;//'ä';
  Key_Kommand[291] = '9';
  Key_Kommand[292] = 0x2B;//'+'; 
  Key_Kommand[304] = 's';
  Key_Kommand[305] = 'z';
  Key_Kommand[306] = KEY_F7;
  Key_Kommand[307] = 0x5E;//'^';
  Key_Kommand[310] = '7';
  Key_Kommand[311] = 'p';
  ...
  bleKeyboard.begin();
 ArduinoOTA.setHostname("BLE_Keyboard");
    ArduinoOTA
      .onStart([]() {
        String type;
